package fr.utbm.CuckoSearch.GLPK;
...
public class Gmpl implements GlpkCallbackListener, GlpkTerminalListener {
    ...
    public static void main(String[] arg) {
        ...
        path[0] = "/Users/mohammeddahhou/Desktop/knapsac.mod";
    ...
    public void solve(String[] arg) {
        ...
        try {
            ...
            File file = new File("/Users/mohammeddahhou/Desktop/knap_sol.sol");

            if (file.createNewFile()) {
                System.out.println("File is created!");
                GLPK.glp_print_sol(lp, String.valueOf(file));
            } else {
                System.out.println("File already exists.");
                GLPK.glp_print_mip(lp, String.valueOf(file));
            }
